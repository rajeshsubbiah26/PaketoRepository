...
import com.vmware.devopsApplications.dto.TestExecutionQueueDTO;
...
public class TestExecutionQueueController
{
    ...
    @RequestMapping(value = "/testexecution/start/{id}/{instance}",method = RequestMethod.GET,produces = MediaType.APPLICATION_JSON_VALUE)
    private ResponseEntity<?> startTestExecutionWithParameters(@PathVariable int id,@PathVariable String instance) throws Exception
    {
        Map responseMap;
        List<String> testExecution=testExecutionQueueService.startTestExecutionBuild(id,instance);
